...
$iter = new RecursiveIteratorIterator(new RecursiveDirectoryIterator('./2023DSA/'));
    ...
    if ($file->getFilename() == '.') {
        ...
        foreach($itens as $item){ 
            if($item->getExtension()=="json") {
                ...
                array_push($tcc, array("titulo" => $grupo->titulo, "curso" => $grupo->curso, 
                        "turma" => $grupo->turma, "arquivo" => str_replace("\\","/",$pasta_grupo."/".$item->getFilename()),
